...
API_KEY = "sk-proj-aYRYOBVO5fmjWh8fiDJbT3BlbkFJpF6dmtc0ePnaMLAUVb7X"    # 可同时填写多个API-KEY，用英文逗号分割，例如API_KEY = "sk-openaikey1,sk-openaikey2,fkxxxx-api2dkey3,azure-apikey4"
...
if USE_PROXY:
    ...
    proxies = {
        #          [协议]://  [地址]  :[端口]
        "http":  "socks5h://localhost:1087",  # 再例如  "http":  "http://127.0.0.1:7890",
        "https": "socks5h://localhost:1080",  # 再例如  "https": "http://127.0.0.1:7890",
    }
    # import os
    # os.environ["http_proxy"] = "http://localhost:1088"
    # os.environ["https_proxy"] = "http://localhost:1088"
else:
    proxies = None
...
AVAIL_LLM_MODELS = ["gpt-4-1106-preview", "gpt-4-turbo-preview", "gpt-4-vision-preview", "gpt-4-turbo", "gpt-4-turbo-2024-04-09",
                    ...
                    "gemini-pro", "chatglm3" , "qwen-turbo"
                    ]
# --- --- --- ---
# P.S. 其他可用的模型还包括
# AVAIL_LLM_MODELS = [
...
# 也可以是具体的模型路径
QWEN_LOCAL_MODEL_SELECTION = "qwen-turbo"


# 接入通义千问在线大模型 https://dashscope.console.aliyun.com/
DASHSCOPE_API_KEY = "sk-5a66992a8713498f89ae8cf782055bd1" # 阿里灵积云API_KEY
